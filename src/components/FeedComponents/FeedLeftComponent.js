...
import styles from '../../styles/FeedLeftComponent.module.css';
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.user}>
        <div className={styles.profileName}>_awesome_arya</div>
        <div>Arya Shahi</div>
        
      </div>
      <div>
        <div>Eagerly waiting for another chocolate n party 🥳😜</div>
